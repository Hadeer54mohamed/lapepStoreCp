...
export default function BannersPage() {
  ...
  <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
    ...
    <ol className="breadcrumb flex gap-2 mt-2 md:mt-0 text-sm text-gray-600 dark:text-gray-300">
      ...
      <li>/</li>
      <li className="text-[#6043FD] dark:text-[#BA6FEE]">البانرات</li>
    </ol>
  </div>
          ...
          >
            ...
            <div className="flex gap-2">
              <Link
                ...
                className="flex-1 bg-gradient-to-r from-[#6043FD] to-[#9861FB] hover:from-[#5033e0] hover:to-[#8750e0] text-white px-3 py-2 rounded-lg text-sm transition font-medium text-center"
              >
              ...
              <button
                ...
                className="flex-1 bg-[#E10E0E] hover:bg-red-600 text-white px-3 py-2 rounded-lg text-sm transition disabled:opacity-50 disabled:cursor-not-allowed font-medium text-center"
              >
            ...
            <div className="mt-3 pt-3 border-t border-[#BA6FEE]">
              <p className="text-xs text-[#011957] dark:text-gray-300">
                تم الإنشاء:{" "}
